...
| `deal_workflow_action_queue` | Build a prioritized queue of the most important next actions across alerts, cleanup, discovery, and review. |
...
34. `deal_market_check`, `deal_watch_identity`, `deal_watch_insights`, `deal_watch_provenance`, `deal_schedule_advice`, `deal_report`, `deal_digest`, `deal_workflow_action_queue`, `deal_workflow_portfolio`, `deal_health`, and `deal_doctor` to audit the current state of the plugin.
